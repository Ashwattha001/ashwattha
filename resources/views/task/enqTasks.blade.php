...
<?php $title=config('constants.PROJECT_NAME'); 
    ...
    $count=count($role);
?>
@section('title',"Project Enquiry Task | $title")
@push('datatable_css')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex flex-wrap">     
                           <h4 class="card-title mb-4">Project Enquiry Task</h4>
                           <div class="ms-auto">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#update_task" role="tab">
                                    <span class="d-block d-sm-none"><i class="far fa-edit"></i></span>
