                            ...
                            <div class="bg-primary bg-soft">
                                <div class="row">
                                     ...
                                     <?php $logo=$u1_obj[0]->logo; ?>
                                        <img src='{{asset("files/company/logo.png")}}' alt="" style="height: 114px;margin-top: 8px;">
                                    </div>
                                    <div class="col-7">
                                    ...
                                    @include('common.alert')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="username" placeholder="Enter Mobile Number" required name="mobile" maxlength="10">
