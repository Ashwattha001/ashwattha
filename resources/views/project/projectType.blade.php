...
<?php $title=config('constants.PROJECT_NAME'); 
    ...
    $count=count($role);
?>
@section('title',"Project Type Management | $title")
@push('datatable_css')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex flex-wrap">     
                           <h4 class="card-title mb-4">Project Type Management</h4>
                           <div class="ms-auto">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#type_list" role="tab">
                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                    <span class="d-none d-sm-block">Project Type List</span> 
                                </a>
                            </li>
                            @if($roles==0)
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#update_type" role="tab">
                                        <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                        <span class="d-none d-sm-block">ADD / Update Project Type</span> 
                                    </a>
                                </li>
                            @endif
                        </ul>
                        <div class="tab-content p-3 text-muted">
                            <div class="tab-pane active" id="type_list" role="tabpanel">
                                    ...
                                    <table class="table table-bordered dt-responsive nowrap w-100 table table-striped" id="datatable"> 
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style="white-space: normal;">Type Name</th>
                            ...
                            <div class="tab-pane" id="update_type" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-12 col-lg-2">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="type_name" placeholder="Enter Type Name" name="type_name" required onkeyup="var start = this.selectionStart;var end = this.selectionEnd;this.value = this.value.toUpperCase();this.setSelectionRange(start, end);" maxlength="20">
                                                <label for="type_name">Type Name<sup class="text-danger">*</sup></label>
...
<script>
    ...
    $('.nav-tabs a[href="#update_type"]').click(function(){
    ...
    $('.nav-tabs a[href="#type_list"]').click(function()
    {
        getType();
    });
    ...
    $(document).on("click",'.editU',function()
    {
        ...
        if(id !=""){
            ...
            $('.nav-tabs a[href="#update_type"]').tab('show');
    ...
    $("#add_dep").click(function(event) 
    {
        ...
        {
            $('#derror').text('Please Enter Type Name');
    ...
    {        
        ...
        {        
            ...
            $.ajax({
                ...
                url:"{{url('post_pro_type')}}",
                type :'post',
                data : {type_name:type_name,edit_id:edit_id,color:color},
                async: false,
                cache: true,
                dataType: 'json',
                success:function(response){
                    ...
                    if (response.status==true) {  
                        ...
                        $('.nav-tabs a[href="#type_list"]').tab('show');
                        //For Notification
