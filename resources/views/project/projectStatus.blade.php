...
<?php $title=config('constants.PROJECT_NAME'); 
    ...
    $count=count($role);
?>
@section('title',"Project Status Management | $title")
@push('datatable_css')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex flex-wrap">     
                           <h4 class="card-title mb-4">Project Status Management</h4>
                           <div class="ms-auto">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#status_list" role="tab">
                                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                    <span class="d-none d-sm-block">Project Status List</span> 
                                </a>
                            </li>
                            @if($roles==0)
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#update_status" role="tab">
                                        <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                        <span class="d-none d-sm-block">ADD / Update Project Status</span> 
                                    </a>
                                </li>
                            @endif
                        </ul>
                        <div class="tab-content p-3 text-muted">
                            <div class="tab-pane active" id="status_list" role="tabpanel">
                                    ...
                                    <table class="table table-bordered dt-responsive nowrap w-100 table table-striped" id="datatable"> 
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style="white-space: normal;">Status Name</th>
                            ...
                            <div class="tab-pane" id="update_status" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-12 col-lg-2">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="status_name" placeholder="Enter Status Name" name="status_name" required onkeyup="var start = this.selectionStart;var end = this.selectionEnd;this.value = this.value.toUpperCase();this.setSelectionRange(start, end);" maxlength="20">
                                                <label for="status_name">Status Name<sup class="text-danger">*</sup></label>
...
<script>
    ...
    $('.nav-tabs a[href="#update_status"]').click(function(){
    ...
    $('.nav-tabs a[href="#status_list"]').click(function()
    {
        getStatus();
    });
    ...
    $(document).on("click",'.editU',function()
    {
        ...
        if(id !=""){
            ...
            $('.nav-tabs a[href="#update_status"]').tab('show');
    ...
    $("#add_dep").click(function(event) 
    {
        ...
        if( $.trim(status_name).length == 0 )
        {
            $('#derror').text('Please Enter Status Name');
    ...
    {        
        ...
        {        
            ...
            $.ajax({
                ...
                url:"{{url('post_pro_status')}}",
                type :'post',
                data : {status_name:status_name,edit_id:edit_id,color:color},
                async: false,
                cache: true,
                dataType: 'json',
                success:function(response){
                    ...
                    if (response.status==true) {  
                        ...
                        $('.nav-tabs a[href="#status_list"]').tab('show');
                        //For Notification
